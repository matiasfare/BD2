...
CREATE OR REPLACE PACKAGE BODY PKG_TRATAMIENTO IS
	...
	BEGIN
		SELECT SESIONES,NRO_SESIONES INTO V_SESIONES,V_NRO_SESIONES FROM TRATAMIENTO WHERE ID_TRATAMIENTO=PID_TRATAMIENTO;
...
BEGIN
PKG_TRATAMIENTO.P_COMPLETAR_SESION(1200,SYSDATE, SYSDATE+3);
END;
/